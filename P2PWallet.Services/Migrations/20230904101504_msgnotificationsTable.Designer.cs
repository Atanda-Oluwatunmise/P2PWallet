...
namespace P2PWallet.Services.Migrations
{
    ...
    [Migration("20230904101504_msgnotificationsTable")]
    partial class msgnotificationsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("P2PWallet.Models.Models.Entities.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SenderUsername", "ReceiverUsername", "DateofChat")
                        .IsDescending();

                    b.ToTable("Chats");
                });

            modelBuilder.Entity("P2PWallet.Models.Models.Entities.ChatNotificationBox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Username", "SenderName")
                        .IsDescending();

                    b.ToTable("ChatNotificationbox");
                });
